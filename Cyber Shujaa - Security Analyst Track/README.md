...
My personal notes, lab walkthroughs, assignments, and reports for the **Cyber Shujaa Security Analyst Track**.
...
```bash
Cyber Shujaa - Security Analyst Track/
├── Week 1 - Computing Essentials/
├── Week 2 - Cyber Security Essentials/
...
├── Week 10 - Security Operations and Monitoring/
